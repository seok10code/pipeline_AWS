...
for dbtb in db_tables:  
    ...
    try:
        ...
        # jdbcDF.
        jdbcDF.repartition(30).write.format('delta').option("mergeSchema", "true").mode('overwrite').save(f"s3://dataproject-bucket/data/{database_name}_aurora/{table_name}/") ## 테이블 저장
